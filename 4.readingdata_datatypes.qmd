...
![](images/clipboard-115945543.png){width="236"}
...
![](images/clipboard-3965218078.png){width="134"}
...
![](images/clipboard-3836050203.png){width="133"}
...
```{r}
fhv <- read_csv("For_Hire_Vehicles__FHV__-_Active_20250822.csv", 
