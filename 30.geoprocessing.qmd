...
⚠️ **Warning!** The subway stations dataset source changed since I created this tutorial. Its CRS is defined as WGS 84 (lat/lon), so you will not be able to define a buffer in miles without changing its CRS. You can use the "Assign projection" tool to change its projection to 2263. See instructions [here](https://pspauster.github.io/urpl_1620_tutorials/20.intro_crs.html#troubleshooting).
...
-   ⚠️ **See the warning message above about changing the subway stations CRS to 2263 before proceeding with the next step.**
