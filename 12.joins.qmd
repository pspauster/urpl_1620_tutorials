...
To avoid confusing and unexpected results like this, it's important to always check for duplicate values in your data, \_especially\_ in columns that you intend to use as a join field.
